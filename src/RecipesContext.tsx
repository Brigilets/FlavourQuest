...
import  { createContext,useContext,ReactNode, useState, useEffect,lazy,Suspense} from "react";
    ...
    async function fetchData(){
        ...
        const fetchedRecipes = []
         try{
            ...
            const res = await fetch(`https://api.edamam.com/api/recipes/v2?type=public&beta=false&app_id=${appID}&app_key=${appKey}&cuisineType=${cuisine}`)
